function randpdf = geo422hw2prob2(N,L,mx)
% randpdf = GEO422HW2PROB2(N,L,mx)
%
% INPUT:
%
% N  is the number of convolutions
% L  is the number of array elements used to create the PDF
% mx is the upper bound for the random numbers chosen to 
%    create the PDF
%
% OUTPUT:
%
% randpdf is the proper PDF that was constructed and 
%         successively convolved with itself  
%
...
% Convolution of our randpdf with itself
